...
//	],
	...
	$grid.jqGrid({    	
        ...
        mtype: 'POST',
        datatype: "JSON",
        colNames:['시퀀스','제목', '작성자', '등록일','조회수','Creator','Status'],
        colModel:[
            ...
            {name:'Creator',index:'Creator', title:false,width:120,search:true,align:"right",resizable:true,
                editable:true,editoptions:{size:"20",maxlength:"30",dataUrl:""}},
               {name:'Status',index:'Status', title:false,width:120,search:true,align:"right",resizable:true,
